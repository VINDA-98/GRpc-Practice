...
var file_protocol_proto_hello_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x2a, 0x2b,
	0x0a, 0x07, 0x53, 0x65, 0x78, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x6e, 0x4b,
	0x6e, 0x6f, 0x77, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x4d, 0x41, 0x4c, 0x45, 0x10, 0x01, 0x12,
	0x0a, 0x0a, 0x06, 0x46, 0x45, 0x4d, 0x41, 0x4c, 0x45, 0x10, 0x02, 0x42, 0x0d, 0x5a, 0x0b, 0x2e,
...
var file_protocol_proto_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_protocol_proto_hello_proto_goTypes = []interface{}{
	...
	nil,                     // 5: protocol.UserInfo.ScoreEntry
	(*ListQuote_Other)(nil), // 6: protocol.ListQuote.Other
}
var file_protocol_proto_hello_proto_depIdxs = []int32{
	0, // 0: protocol.UserInfo.sex:type_name -> protocol.SexType
	5, // 1: protocol.UserInfo.score:type_name -> protocol.UserInfo.ScoreEntry
	3, // 2: protocol.ListQuote.articles:type_name -> protocol.Quote
	6, // 3: protocol.ListQuote.others:type_name -> protocol.ListQuote.Other
